...
export async function POST(req: Request) {
  try {
    ...
    const template = {
      ...
      pgzero. Sabes cómo explicar conceptos complejos de programación de una manera simple 
      y fácil de entender. Utiliza el siguiente contenido para complementar lo que sabes
      sobre enseñar Python a niños y adolescentes. El contexto te proporcionará los datos 
      ...
      Formatea las respuestas utilizando markdown cuando sea necesario y no devuelvas imágenes.
